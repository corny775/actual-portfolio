...
import { SiCplusplus, SiFigma, SiHtml5, SiMysql } from "react-icons/si";
import { SiPython, SiC, SiCss3, SiUnity } from "react-icons/si";
        ...
        <div className="border-b border-neutral-800 pb-24">
            ...
            className="flex flex-wrap items-center justify-center gap-4">
                ...
                className="rounded-2xl border-4 border-neutral-800 p-4">
                    <SiC className="text-7xl text-cyan-400"/>
                </motion.div>
                <motion.div 
                ...
                animate="animate"
                className="rounded-2xl border-4 border-neutral-800 p-4">
                    <SiUnity className="text-7xl text-cyan-400"/>
                </motion.div>
                <motion.div 
                variants={iconVariants(2)}
                initial="initial"
                animate="animate"
                className="rounded-2xl border-4 border-neutral-800 p-4">
                    <FaCoffee className="text-7xl text-cyan-400"/>
                </motion.div>
            </motion.div>
        </div>
    );
